...
import com.astuetz.viewpager.extensions.fragment.Fragment_Settings;
import com.astuetz.viewpager.extensions.sample.R;


 public abstract class Dialog_Split {
    ...
    public static Dialog getDialog(final Context c, final int totalSteps) {
        ...
        ((TextView) d.findViewById(R.id.steps))
                .setText(Integer.toString(totalSteps - split_steps));

        float stepsize = prefs.getFloat("stepsize_value", 75f);
        float distance = (totalSteps - split_steps) * stepsize;
        if (prefs.getString("stepsize_unit", "cm").equals("cm")) {
            distance /= 100000;
